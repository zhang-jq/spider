...
-- ----------------------------
-- Table structure for product_ichemistry
-- ----------------------------
DROP TABLE IF EXISTS `product_ichemistry`;
CREATE TABLE `product_ichemistry`  (
  ...
  `goods_alias` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
